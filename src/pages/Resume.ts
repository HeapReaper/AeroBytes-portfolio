...
export function Resume(): HTMLElement {
  ...
  resumeSection.innerHTML = `
    ...
    <div class="container">
      <div class="row resume-row justify-content-center">
        <div class="col-lg-6 resume-col" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                ...
                <li>
                  Making manuals for other<br> helpdesk employees
                </li>
              </ul>
            </div>
